defmodule Pow.Plug do
  ...
  be stored in as private `:pow_config_NAMESPACE` key in the connection. This
  key will be fetched in `fetch_config/1` if `:pow_namespace`
  private key with the namespace value exists in the connection.
  """
